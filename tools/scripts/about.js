...
_CN("a", {href:"https://github.com/EasyEDA2021/easyeda-i18n", target:"_blank"}, ["Open Translations on GitHub"], divT);
_CN("br", null, null, divT);
_CN("p", {style:"float:right;"}, ["Scripts developed by", _CN("br"), "Adriano Petrucci", _CN("br"), "v1.2"], divT);
api('createCommand', {
